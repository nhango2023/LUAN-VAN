...
- Yêu cầu đáp án sai:
    ...
    + Các đáp án sai PHẢI CÓ độ dài (ký tự) bằng hoặc lớn hơn đáp án đúng. 
...
- Yêu cầu đáp án đúng:
    ...
    + Trả lời PHẢI đúng câu hỏi, PHẢI đủ ý và đúng hơn các đáp án sai và có thể tìm thấy trong tài liệu.
...
- Yêu cầu trích dẫn:
    ...
    - Sử dụng thông tin trong tài liệu vào chứng minh.
...
2. Đánh giá câu trả lời được gợi ý:
    - Nếu trả lời được gợi ý bao gồm các đáp án khác thì đúng với câu hỏi và các đáp án khác có thể tìm thấy trong tài liệu: `binary_score = "yes"`.
