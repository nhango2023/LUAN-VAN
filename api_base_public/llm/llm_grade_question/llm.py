...
class LLM_GRADE_QUESTION:
    ...
    def __init__(self, temperature: float = 0.0, max_tokens: int = 4096, n_ctx: int = 4096,  log_file_path: str="") -> None:
    ...
    def grok_ai(self):
        ...
        """
        self.write_log('use grok to grade qs')
        print('use grok to grade qs')
        llm = ChatXAI(
    ...
    def open_ai(self):
        ...
        """
        self.write_log('use gpt to grade qs')
        print('use gpt to grade qs')
        llm = ChatOpenAI(
    ...
    def gemini(self):
        ...
        """
        self.write_log('use gemini to grade qs')
        print('use gemini to grade qs')
