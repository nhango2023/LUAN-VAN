                ...
                @endif
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="personal" role="tabpanel">
                            <form action="{{ route('admin.user.personal.edit', ['id' => $user->id]) }}"  method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <!-- Hiển thị ảnh -->
                                ...
                                <div class="form-group">
                                    <label>Address</label>
                                    <input type="text" name='address' class="form-control" value="{{ $user->dia_chi }}">
                                </div>
                                <div class="form-group">
                                    <label>Phone number</label>
                                    <input type="text" name="phone" class="form-control" value="{{ $user->sdt }}">
                                </div>
